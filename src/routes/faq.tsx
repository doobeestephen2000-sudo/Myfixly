...
const FAQS = [
  ...
  { q: "How do I contact an artisan?", a: "Open a professional's profile and send a service request through the form." },
...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      { title: "FAQ — Myfixly" },
      { name: "description", content: "Frequently asked questions about using Myfixly as a customer or artisan." },
    ],
  }),
  component: FAQ,
});
