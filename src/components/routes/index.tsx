        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <form
              ...
              className="mx-auto mt-8 flex max-w-2xl flex-col gap-2 rounded-2xl border border-border bg-card p-2 shadow-elegant sm:flex-row"
            >
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  placeholder="Search brand, service, mechanic..."
              ...
              <select
                ...
                className="h-11 rounded-md border-0 bg-transparent px-3 text-sm focus:outline-none"
              >
                <option value="">All states</option>
                {NIGERIA_STATES.map((s) => <option key={s} value={s}>{s}</option>)}
              </select>
              <Button type="submit" size="lg" className="shadow-elegant">Search</Button>
            </form>
